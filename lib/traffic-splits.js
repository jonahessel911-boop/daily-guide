...
const ROUTES = {
  ...
  zittu: {
    slug: 'zittu',
    checker_url: '/zittu-checker',
    cookie_name: 'ts_zittu',
    product_slug: 'zittu',
    default_variants: [
      {
        route_slug: 'zittu',
        lander_slug: 'adv-1',
        destination_path: '/zittu/adv/1/',
        label: 'Adv/1 — Advertorial',
        weight_percent: 25,
        product_slug: 'zittu',
        country: 'NL',
        active: true,
      ...
      },
      {
        route_slug: 'zittu',
        lander_slug: 'adv-2',
        destination_path: '/zittu/adv/2/',
        label: 'Adv/2 — Quiz funnel',
        weight_percent: 25,
        product_slug: 'zittu',
        country: 'NL',
        active: true,
      ...
      },
      {
        route_slug: 'zittu',
        lander_slug: 'adv-3',
        destination_path: '/zittu/adv/3/',
        label: 'Adv/3 — Stoelen test',
        weight_percent: 25,
        product_slug: 'zittu',
        country: 'NL',
        active: true,
      ...
      },
      {
        route_slug: 'zittu',
        lander_slug: 'adv-4',
        destination_path: '/zittu/adv/4/',
        label: 'Adv/4 — 1-staps form',
        weight_percent: 25,
        product_slug: 'zittu',
        country: 'NL',
        active: true,
